...
SOURCE_REPOSITORY="git@github.com:Qiskit/qiskit-ibm-runtime.git"
SOURCE_DIR=`pwd`
SOURCE_LANG='en'
...
tox -egettext -- -D language=$SOURCE_LANG -D content_prefix=ecosystem/ibm-runtime
...
git config user.name "Qiskit (IBM Runtime) Autodeploy"
